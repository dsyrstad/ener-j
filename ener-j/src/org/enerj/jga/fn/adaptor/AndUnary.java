// ============================================================================
// $Id: AndUnary.java,v 1.3 2005/08/12 02:56:44 dsyrstad Exp $
...
/**
 * Unary that performs a shortcircuit and operation using a given pair of
 * Boolean UnaryFunctors.  When the first functor returns true, the second
 * is not evaluated.
 **/

public class AndUnary<T> extends UnaryPredicate<T> {

    static final long serialVersionUID = -4087333621367458086L;
     ...
     */
    public AndUnary(UnaryFunctor<T,Boolean> first, UnaryFunctor<T,Boolean> second) {
    ...
    /**
     * Calls the Visitor's <code>visit(AndUnary)</code> method, if it
     * implements the nested Visitor interface.
     */
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof AndUnary.Visitor)
            ((AndUnary.Visitor)v).visit(this);
    }
    ...
    /**
     * Interface for classes that may interpret an <b>AndUnaryFunctor</b> predicate.
     */
