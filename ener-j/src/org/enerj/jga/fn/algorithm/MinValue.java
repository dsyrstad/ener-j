// ============================================================================
// $Id: MinValue.java,v 1.3 2005/08/12 02:56:50 dsyrstad Exp $
...
public class MinValue<T> extends UnaryFunctor<Collection<? extends T>, T> {
    
    static final long serialVersionUID = 8518667936731775433L;
     ...
     * its two arguments and return the lesser value.
    ...
    public T fn(Collection<? extends T> collection) {
        return Collections.min(collection, _comp);
    }
    
    /**
     * Calls the Visitor's <code>visit(MinValue)</code> method, if it
     * implements the nested Visitor interface.
     */
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof MinValue.Visitor)
            ((MinValue.Visitor)v).visit(this);
    }
    ...
    /**
     * Interface for classes that may interpret an <b>MinValue</b> functor.
     */
    public interface Visitor extends org.enerj.jga.fn.Visitor {
        public void visit(MinValue host);
    }
}
