// ============================================================================
// $Id: ReplaceAll.java,v 1.3 2005/08/12 02:56:50 dsyrstad Exp $
...
/**
 * Replaces all instances in an iteration that pass the given test with the
 * given value.
 * <p>
...
public class ReplaceAll<T>
    extends UnaryFunctor<Iterator<? extends T>, TransformIterator<T,T>>
{
    static final long serialVersionUID = -6156225521195687370L;

    // The functor used determine which elements to replace
    private UnaryFunctor<T,T> _fn;

    // the value that replaces some items
    private T _value;
    ...
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof ReplaceAll.Visitor)
            ((ReplaceAll.Visitor)v).visit(this);
    }
