// ============================================================================
// $Id: UnsignedShiftRight.java,v 1.3 2005/08/12 02:56:44 dsyrstad Exp $
...
public class UnsignedShiftRight<T extends Number> extends BinaryFunctor<T,Integer,T> {
    
    static final long serialVersionUID = 8361184503268806351L;
    ...
    /**
     * Builds UnsignedShiftRight functor for the given class.  The class argument must
     ...
     */
    public UnsignedShiftRight(Class<T> c) {
    ...
    public T fn(T x, Integer y) {
        try {
            return _math.unsignedShiftRight(x, y);
        }
        catch (ClassCastException ex) {
            String msg = "ClassCastException: Cannot compute shiftRight of {0}[{1}] and {2}[{3}]";
    ...
    /**
     * Calls the Visitor's <code>visit(UnsignedShiftRight)</code> method, if it implements
     * the nested Visitor interface.
     */
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof UnsignedShiftRight.Visitor)
            ((UnsignedShiftRight.Visitor)v).visit(this);
    }
    ...
    /**
     * Interface for classes that may interpret a <b>UnsignedShiftRight</b> functor.
     */
    public interface Visitor extends org.enerj.jga.fn.Visitor {
        public void visit(UnsignedShiftRight host);
    }
}
