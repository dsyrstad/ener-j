...
// $Header: /cvsroot/ener-j/ener-j/src/org/enerj/sco/JavaSqlTimeSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
...
/**
 * Second Class Object subclass for java.sql.Time.
 *
 * @version $Id: JavaSqlTimeSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
 * @author <a href="mailto:dsyrstad@ener-j.org">Dan Syrstad</a>
 */
public class JavaSqlTimeSCO extends java.sql.Time implements SCOTracker
{
     ...
     */
    public JavaSqlTimeSCO(long aMillisTime, Persistable anOwnerFCO)
    {
        super(aMillisTime);
    ...
    //----------------------------------------------------------------------
    // Overridden mutator methods from java.sql.Time.
    //----------------------------------------------------------------------
