...
// $Header: /cvsroot/ener-j/ener-j/src/com/vscorp/ui/swing/table/objectSource/ReflectedProgressColumn.java,v 1.1 2005/11/20 03:12:22 dsyrstad Exp $
...
/**
 * Represents a progress column for an ObjectSource.
 ...
 * <p>
 */
public class ReflectedProgressColumn extends ProgressColumn
{
     ...
     *  anObjectClass.
     */
    public ReflectedProgressColumn(Class anObjectClass, String anAttributeName, String[] someArgs)
    {
     ...
     *  anObjectClass.
     */
    public ReflectedProgressColumn(Class anObjectClass, String anAttributeName)
    {
        this("", true, anObjectClass, anAttributeName);
    }
     ...
     *  anObjectClass.
     */
    public ReflectedProgressColumn(String aColumnTitle, boolean anEditingFlag,
     ...
     */
    protected Integer getColumnValue(Object anObject)
    {
        try {
            Number number = (Number)mField.get(anObject);
            if (number instanceof Double || number instanceof Float) {
                return new Integer( (int)(number.doubleValue() * 100.) );
            }
            else {
     ...
     *  it is invalid.
     */
    protected boolean setColumnValue(Object anObject, Integer aValue)
    {
        try {
