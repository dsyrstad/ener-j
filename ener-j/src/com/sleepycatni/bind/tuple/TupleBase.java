...
package com.sleepycatni.bind.tuple;
 ...
 * instance, which is also a {@link com.sleepycatni.util.FastOutputStream}
...
public class TupleBase {
     ...
     * com.sleepycatni.util.FastOutputStream#DEFAULT_INIT_SIZE} size will be
     * used.</p>
     */
    public TupleBase() {
        outputBufferSize = 0;
     ...
     * com.sleepycatni.util.FastOutputStream#DEFAULT_INIT_SIZE} size is used.</p>
     *
     ...
     * {@link com.sleepycatni.util.FastOutputStream#reset} method before each
     * use.</p>
     *
