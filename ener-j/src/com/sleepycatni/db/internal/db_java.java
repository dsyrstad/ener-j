...
/* package */ class db_java {
  public static void DbEnv_lock_vec(DbEnv dbenv, int locker, int flags, com.sleepycatni.db.LockRequest[] list, int offset, int nlist) throws com.sleepycatni.db.DatabaseException {
