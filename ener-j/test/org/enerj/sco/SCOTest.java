...
{
    private static final String DATABASE_URI = "enerj://root:root@-/SCOTestDB?DefaultMetaObjectServer.ObjectServerClass=org.enerj.server.MemoryObjectServer";
    ...
    public void testSCOs() throws Exception
    {
        ...
        database.open("enerj://root:root@-/SCOTestDB?DefaultMetaObjectServer.ObjectServerClass=org.enerj.server.MemoryObjectServer", EnerJDatabase.OPEN_READ_WRITE);
