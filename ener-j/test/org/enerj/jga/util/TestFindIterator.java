// ============================================================================
// $Id: TestFindIterator.java,v 1.3 2005/08/12 02:56:50 dsyrstad Exp $
...
public class TestFindIterator extends TestCase {
    ...
    static public UnaryFunctor<String,Boolean> eqQlx =
        new EqualTo<String>().bind2nd(QLX);

    public TestFindIterator (String name){ super(name); }
    ...
    public void testOnePass() {
        FindIterator<String> iter = new FindIterator<String>(list.iterator());
    ...
    public void testNotFound() {
        FindIterator<String> iter = new FindIterator<String>(list.iterator());
        assertTrue(!iter.findNext(eqQlx));
        try
        {
            iter.next();
    ...
    public void testNoMoreFound() {
        FindIterator<String> iter = new FindIterator<String>(list.iterator());
        iter.findNext(eqBar);
        assertEquals(BAR, iter.next());
        iter.findNext(eqBar);
        assertEquals(BAR, iter.next());
        assertTrue(!iter.findNext(eqBar));
    }
 
    static public void main (String[] args) {
        junit.swingui.TestRunner.run(TestFindIterator.class);
    }
}
