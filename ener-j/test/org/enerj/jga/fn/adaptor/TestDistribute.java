// ============================================================================
// $Id: TestDistribute.java,v 1.3 2005/08/12 02:56:44 dsyrstad Exp $
...
public class TestDistribute
    extends FunctorTest<Distribute<String,String,Integer,Date,String>>
{
    ...
    public TestDistribute (String name){ super(name); }

    private SampleUnaryFunctor<String,Integer> inner1 =
            new SampleUnaryFunctor<String,Integer>(FOO, ONE);
    
    private SampleUnaryFunctor<String,Date> inner2 =
            new SampleUnaryFunctor<String,Date>(BAR, NOW);

    private SampleBinaryFunctor<Integer,Date,String> outer =
            new SampleBinaryFunctor<Integer,Date,String>(ONE, NOW, BAZ);
    
    private Distribute<String,String,Integer,Date,String> func =
        new Distribute<String,String,Integer,Date,String>(inner1, inner2, outer);

    public void testFunctorInterface() {
        assertEquals(BAZ, func.fn(FOO, BAR));
        assertEquals(FOO, inner1._got);
        assertEquals(BAR, inner2._got);
        assertEquals(ONE, outer._gotX);
        assertEquals(NOW, outer._gotY);
    }
    
    public void testSerialization() {
        Distribute<String,String,Integer,Date,String> f2 = makeSerial(func);
    ...
    static public void main (String[] args) {
        junit.swingui.TestRunner.run(TestDistribute.class);
    }

    private class TestVisitor extends AbstractVisitor
            implements Distribute.Visitor
    {
        public Object host;
        public void visit(Distribute host) { this.host = host; }
    }
}
