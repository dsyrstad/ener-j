...
import com.sleepycatni.util.UtfOps;
 ...
 * <ol>
 * <li>When using the {@link com.sleepycatni.db} package directly, the static
 * methods in this class can be used to convert between primitive values and
 * {@link DatabaseEntry} objects.</li>
 * <li>When using the {@link com.sleepycatni.collections} package, an instance of
