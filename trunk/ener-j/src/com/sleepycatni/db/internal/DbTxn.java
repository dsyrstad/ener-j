...
public class DbTxn {
  ...
  public String get_name() throws com.sleepycatni.db.DatabaseException {
    return db_javaJNI.DbTxn_get_name(swigCPtr);
  }

  public int id() throws com.sleepycatni.db.DatabaseException { return db_javaJNI.DbTxn_id(swigCPtr); }

  public void prepare(byte[] gid) throws com.sleepycatni.db.DatabaseException { db_javaJNI.DbTxn_prepare(swigCPtr, gid); }

  public void set_timeout(long timeout, int flags) throws com.sleepycatni.db.DatabaseException { db_javaJNI.DbTxn_set_timeout(swigCPtr, timeout, flags); }

  public void set_name(String name) throws com.sleepycatni.db.DatabaseException { db_javaJNI.DbTxn_set_name(swigCPtr, name); }
