 ...
 * instance, which is also a {@link com.sleepycatje.util.FastOutputStream}
...
public class TupleBase {
     ...
     * com.sleepycatje.util.FastOutputStream#DEFAULT_INIT_SIZE} size will be
     * used.</p>
     */
    public TupleBase() {
        outputBufferSize = 0;
     ...
     * com.sleepycatje.util.FastOutputStream#DEFAULT_INIT_SIZE} size is used.</p>
     *
     ...
     * {@link com.sleepycatje.util.FastOutputStream#reset} method before each
     * use.</p>
     *
