...
// $Header: /cvsroot/ener-j/ener-j/src/com/vscorp/ui/swing/table/objectSource/ReflectedDateColumn.java,v 1.1 2005/11/20 03:12:22 dsyrstad Exp $
...
/**
 * Represents a date column for an ObjectSource.
 ...
 * <p>
 */
public class ReflectedDateColumn extends ReflectedDateTimeColumn
{
     ...
     *  anObjectClass.
     */
    public ReflectedDateColumn(Class anObjectClass, String anAttributeName, String[] someArgs)
    {
        this("", true,
     ...
     *  anObjectClass.
     */
    public ReflectedDateColumn(Class anObjectClass, String anAttributeName)
    {
     ...
     *  anObjectClass.
     */
    public ReflectedDateColumn(String aColumnTitle, boolean anEditingFlag,
                ...
                DateFormat aDateTimeFormat, Class anObjectClass, String anAttributeName)
    {
        super(aColumnTitle, anEditingFlag,
            (aDateTimeFormat == null) ? DateFormat.getDateInstance(DateFormat.SHORT) : aDateTimeFormat,
            anObjectClass, anAttributeName);
    }
