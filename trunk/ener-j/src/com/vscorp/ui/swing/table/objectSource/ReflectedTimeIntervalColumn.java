...
// $Header: /cvsroot/ener-j/ener-j/src/com/vscorp/ui/swing/table/objectSource/ReflectedTimeIntervalColumn.java,v 1.1 2005/11/20 03:12:22 dsyrstad Exp $
...
public class ReflectedTimeIntervalColumn extends TimeIntervalColumn
{
     ...
     *  anObjectClass.
     */
    public ReflectedTimeIntervalColumn(String aColumnTitle, boolean anEditingFlag,
    ...
    protected Long getColumnValue(Object anObject)
    {
        try {
            ...
            // Assume it's an object whose String can be converted to a interval (Long).
