 ...
 */
public class BDBNIExtentIterator implements ExtentIterator
{
    ...
    private BDBNIObjectServer.Session session;
     ...
     */
    public BDBNIExtentIterator(BDBNIObjectServer.Session session, Cursor cursor, List<DatabaseEntry> cidKeys, LockMode lockMode) throws ODMGRuntimeException
    {
        this.cursor = cursor;
