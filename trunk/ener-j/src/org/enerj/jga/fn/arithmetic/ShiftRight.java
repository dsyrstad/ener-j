// ============================================================================
// $Id: ShiftRight.java,v 1.3 2005/08/12 02:56:44 dsyrstad Exp $
...
public class ShiftRight<T extends Number> extends BinaryFunctor<T,Integer,T> {
    
    static final long serialVersionUID = 4910289709792083209L;
    ...
    /**
     * Builds ShiftRight functor for the given class.  The class argument must
    ...
    public T fn(T x, Integer y) {
        try {
            return _math.signedShiftRight(x, y);
        }
    ...
    /**
     * Calls the Visitor's <code>visit(ShiftRight)</code> method, if it implements
     * the nested Visitor interface.
     */
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof ShiftRight.Visitor)
            ((ShiftRight.Visitor)v).visit(this);
    }
    ...
    /**
     * Interface for classes that may interpret a <b>ShiftRight</b> functor.
     */
    public interface Visitor extends org.enerj.jga.fn.Visitor {
        public void visit(ShiftRight host);
    }
}
