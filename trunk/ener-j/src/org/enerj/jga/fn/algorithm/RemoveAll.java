// ============================================================================
// $Id: RemoveAll.java,v 1.3 2005/08/12 02:56:50 dsyrstad Exp $
...
/**
 * Removes instances from an iteration.  This functor returns an interator that
...
public class RemoveAll<T>
    extends UnaryFunctor<Iterator<? extends T>, FilterIterator<T>>
{
    ...
    public void accept(org.enerj.jga.fn.Visitor v) {
        if (v instanceof RemoveAll.Visitor)
            ((RemoveAll.Visitor)v).visit(this);
    }
