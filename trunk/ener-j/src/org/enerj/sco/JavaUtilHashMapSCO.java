...
// $Header: /cvsroot/ener-j/ener-j/src/org/enerj/sco/JavaUtilHashMapSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
...
/**
 * Second Class Object subclass for java.util.HashMap.
 *
 * @version $Id: JavaUtilHashMapSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
 * @author <a href="mailto:dsyrstad@ener-j.org">Dan Syrstad</a>
 */
public class JavaUtilHashMapSCO extends java.util.HashMap implements SCOTracker
{
     ...
     */
    public JavaUtilHashMapSCO(int anInitialCapacity, Persistable anOwnerFCO)
    {
    ...
    //----------------------------------------------------------------------
    // Overridden mutator methods from java.util.HashMap.
    //----------------------------------------------------------------------
