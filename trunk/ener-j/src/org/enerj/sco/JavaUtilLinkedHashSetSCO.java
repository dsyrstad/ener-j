...
// $Header: /cvsroot/ener-j/ener-j/src/org/enerj/sco/JavaUtilLinkedHashSetSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
...
/**
 * Second Class Object subclass for java.util.LinkedHashSet.
 *
 * @version $Id: JavaUtilLinkedHashSetSCO.java,v 1.3 2005/08/12 02:56:45 dsyrstad Exp $
 * @author <a href="mailto:dsyrstad@ener-j.org">Dan Syrstad</a>
 */
public class JavaUtilLinkedHashSetSCO extends java.util.LinkedHashSet implements SCOTracker
{
     ...
     */
    public JavaUtilLinkedHashSetSCO(int anInitialCapacity, Persistable anOwnerFCO)
    {
    ...
    //----------------------------------------------------------------------
    // Overridden mutator methods from java.util.LinkedHashSet.
    //----------------------------------------------------------------------
