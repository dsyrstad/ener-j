// ============================================================================
// $Id: TestCachingIterator.java,v 1.3 2005/08/12 02:56:50 dsyrstad Exp $
...
public class TestCachingIterator extends TestCase {
    public TestCachingIterator (String name){ super(name); }
    ...
    public void testCaching1() {
        CachingIterator<String> iter =
            new CachingIterator<String>(list.iterator(), 1);
        ...
        try {
            iter.cached(-1);
            fail("Expected NoSuchElementException when cached(2) called "
                 +"(2 > size)");
        }
        catch (NoSuchElementException x) {}
    ...
    public void testCachingN() {
        CachingIterator<String> iter =
            new CachingIterator<String>(list.iterator(), 3);
        ...
        try {
            iter.cached(-1);
            fail("Expected NoSuchElementException when cached(4) called "
                 +"(4 > size)");
        }
        catch (NoSuchElementException x) {}
    ...
    public void testCachingMoreThanSize() {
        CachingIterator<String> iter =
            new CachingIterator<String>(list.iterator(), 5);
