// ============================================================================
// $Id: TestNotEqualTo.java,v 1.3 2005/08/12 02:56:44 dsyrstad Exp $
...
public class TestNotEqualTo extends FunctorTest<NotEqualTo<Boolean>> {
    public TestNotEqualTo (String name){ super(name); }

    private NotEqualTo<Boolean> pred = makeSerial(new NotEqualTo<Boolean>());
    ...
    private class TestVisitor extends AbstractVisitor
            implements NotEqualTo.Visitor
    {
        public Object host;
        public void visit(NotEqualTo host) { this.host = host; }
    }
