// ============================================================================
// $Id: TestGreater.java,v 1.4 2006/01/12 23:36:19 dsyrstad Exp $
...
public class TestGreater extends FunctorTest<Greater<Integer>> {
    public TestGreater (String name){ super(name); }

    private Integer ZERO = new Integer(0);
    private Integer ONE  = new Integer(1);
    
    private Greater<Integer> pred = makeSerial(new Greater.Comparable<Integer>());
    ...
    private class TestVisitor extends AbstractVisitor
            implements Greater.Visitor
    {
        public Object host;
        public void visit(Greater host) { this.host = host; }
    }
    
    static public void main (String[] args) {
        junit.swingui.TestRunner.run(TestGreater.class);
    }
}
