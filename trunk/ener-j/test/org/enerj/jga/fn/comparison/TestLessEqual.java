// ============================================================================
// $Id: TestLessEqual.java,v 1.4 2006/01/12 23:36:19 dsyrstad Exp $
...
public class TestLessEqual extends FunctorTest<LessEqual<Integer>> {
    public TestLessEqual (String name){ super(name); }

    private Integer ZERO = new Integer(0);
    private Integer ONE  = new Integer(1);
    
    private LessEqual<Integer> pred = makeSerial(new LessEqual.Comparable<Integer>());
    ...
    private class TestVisitor extends AbstractVisitor
            implements LessEqual.Visitor
    {
        public Object host;
        public void visit(LessEqual host) { this.host = host; }
    }

    static public void main (String[] args) {
        junit.swingui.TestRunner.run(TestLessEqual.class);
    }
}
